        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                            <img src="{{$thrid_post->featured}}" alt="seo">
                            <div class="overlay"></div>
                            <a href="{{$thrid_post->featured}}" class="link-image js-zoom-image">
                                <i class="seoicon-zoom"></i>
                            </a>
                            <a href="#" class="link-post">
                                <i class="seoicon-link-bold"></i>
                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <h2 class="post__title entry-title text-center">
                                        <a href="{{ route('single.post',$thrid_post->slug) }}">{{$thrid_post->title}}</a>
                                    </h2>
                                    ...
                                    <div class="post-additional-info">
                                        ...
                                        <span class="post__date">
                                            ...
                                            <time class="published" datetime="2016-04-17 12:00:00">
                                              {{$thrid_post->created_at->toFormattedDateString()}}
                                            </time>
                                        ...
                                        <span class="category">
                                            <i class="seoicon-tags"></i>
                                            <a href="{{ route('category.single',$thrid_post->category->id) }}">{{$thrid_post->category->name}}</a>
                                        </span>
